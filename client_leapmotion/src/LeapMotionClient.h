...
private:
	...
	vr::HmdQuaternion_t leftRotationOffset = vrmath::quatFromRotationYXZ(0.0f, -0.1f, 0.0f);
	...
	vr::HmdQuaternion_t rightRotationOffset = vrmath::quatFromRotationYXZ(0.0f, -0.1f, 0.0f);
